...
export default function ProfilePage() {
  ...
  const displayMembership = (() => {
    const t = (user?.membershipType ?? "").toString().toLowerCase();

    if (t === "premium") return "Premium";
    if (t === "standard") return "Standard";

    // If DB/session contains unexpected value like "member", treat as Standard.
    if (t === "member") return "Standard";
      ...
      <main className="max-w-3xl mx-auto px-5 md:px-10 py-8 md:py-10 pb-24 md:pb-10 flex flex-col gap-8">
        ...
        <div className="bg-white rounded-3xl p-6 md:p-8 border border-[#E8E4DC] flex flex-col gap-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              { label: "Membership Type", value: displayMembership },
