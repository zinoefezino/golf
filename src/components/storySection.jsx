...
const CONTENT = {
  ...
  about: {
    ...
    img2: { src: "/img9.avif", alt: "Clubhouse", label: "Elegant clubhouse" },
    img3: { src: "/img8.avif", alt: "Players", label: "A place to belong" },
  },
  game: {
    ...
    img1: { src: "/img1.avif", alt: "Tee", label: "Precision terrain" },
    img2: { src: "/img11.avif", alt: "Green", label: "Tournament greens" },
    img3: { src: "/hero2.webp", alt: "Aerial", label: "Every round refined" },
  },
};
  ...
  return (
    <section className="bg-[#F6F3EE] px-6 py-20 md:px-10 md:py-28">
      <div className="mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-2 lg:gap-20">
        ...
        <div className="order-2 lg:order-1 flex flex-col gap-4 lg:grid lg:h-140 lg:grid-cols-6 lg:grid-rows-6 lg:gap-3">
